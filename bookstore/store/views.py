...
from .models import Category, Writer, Book, Review, Slider, Users
from order.models import Order
from cart.cart import Cart
from .serializers import CategorySerializer, WriterSerializer, BookSerializer, ReviewSerializer, CartSerializer, OrderSerializer
...
def rentbook(request, id):
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            return render(request, "store/rentbook.html", {"book": book})
    else:
        return redirect('store:signin')