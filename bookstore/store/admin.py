...
class AddReview(admin.ModelAdmin):
	list_display = ['customer', 'book', 'review_star', 'review_text', 'created']
	list_filter = ['created']
	list_editable = ['review_text', 'review_star']

admin.site.register(Review, AddReview)
